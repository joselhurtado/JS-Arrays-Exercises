...
var lowerCase = people.map(element => {
    return element.toLowerCase();
    }); 
     console.log(lowerCase); // Convert all Strings to lowercase usin Map Method 

const index = people.indexOf('Waldo')

//loop here to find waldo, use the if conditionals
    for (const currentName of people) {
        if (currentName == 'Waldo') {
        console.log(currentName,'Index Is Here', index )
        }
    } // Find Waldo String */